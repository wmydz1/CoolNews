...
public class LinkServlet extends HttpServlet {
	...
	private void linkPreSave(HttpServletRequest request, HttpServletResponse response) throws IOException {
		String linkId = request.getParameter("linkId");
		Connection con = null;
	...
	private void linkSave(HttpServletRequest request, HttpServletResponse response) throws IOException {
		Connection con = null;
		String linkId = request.getParameter("linkId");
